...
;; *************** function _main *****************
;; Defined at:
;;		line 92 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
...
;;
psect	maintext
	file	"C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
	line	92
...
l2419:	
;I2c.c: 98: SSPSTAT=0XC0;
	movlw	(0C0h)
	movwf	(148)^080h	;volatile
	line	99
	
l2421:	
;I2c.c: 99: SSPCON=0X28;
	movlw	(028h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(20)	;volatile
...
l2429:	
;I2c.c: 104: lcd_display("CLOCK:");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_lcd_display
	line	105
	
l2431:	
;I2c.c: 105: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
l2435:	
;I2c.c: 107: lcd_display("DATE:");
	movlw	((STR_2-__stringbase))&0ffh
	fcall	_lcd_display
	line	109
	
l2437:	
;I2c.c: 109: DS1307_WRITE(0,11,3,1,22,11,12);
	movlw	(0Bh)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(??_main+0)+0
...
l2441:	
;I2c.c: 112: {
;I2c.c: 113: DS1307_READ(0xD0,0X00);
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
;; Defined at:
;;		line 227 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
...
l2359:	
;I2c.c: 234: SSPBUF=slave_add;
	movf	(DS1307_READ@slave_add),w
	movwf	(19)	;volatile
	line	235
;I2c.c: 235: while(SSPIF==0);
	goto	l684
...
l2361:	
;I2c.c: 240: SSPBUF=reg_add;
	movf	(DS1307_READ@reg_add),w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(19)	;volatile
	line	241
;I2c.c: 241: while(SSPIF==0);
	goto	l690
...
l2363:	
;I2c.c: 251: SSPBUF=slave_add+1;
	movf	(DS1307_READ@slave_add),w
	addlw	01h
	movwf	(19)	;volatile
	line	252
;I2c.c: 252: while(SSPIF==0);
	goto	l699
...
;I2c.c: 318: lcd_command(0x88);
	...
	fcall	_lcd_command
	line	319
;I2c.c: 319: bcd_to_ascii(hr1);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_hr1),w
	fcall	_bcd_to_ascii
	line	320
;I2c.c: 320: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
;I2c.c: 325: lcd_data(':');
	...
	fcall	_lcd_data
	line	327
;I2c.c: 327: bcd_to_ascii(sec1);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_sec1),w
	fcall	_bcd_to_ascii
	line	328
;I2c.c: 328: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
;; Defined at:
;;		line 119 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
...
;; Defined at:
;;		line 146 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
...
l2315:	
;I2c.c: 154: SSPBUF=0xD0;
	movlw	(0D0h)
	movwf	(19)	;volatile
	line	155
;I2c.c: 155: while(SSPIF==0);
	goto	l615
...
l2317:	
;I2c.c: 160: SSPBUF=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(19)	;volatile
	line	161
;I2c.c: 161: while(SSPIF==0);
	goto	l621
...
l2319:	
;I2c.c: 166: SSPBUF=decimal_to_bcd(_sec);
...
l2321:	
;I2c.c: 173: SSPBUF=decimal_to_bcd(_min);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l2323:	
;I2c.c: 180: SSPBUF=decimal_to_bcd(_hr);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l2325:	
;I2c.c: 186: SSPBUF=decimal_to_bcd(_day);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l2327:	
;I2c.c: 193: SSPBUF=decimal_to_bcd(_date);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l2329:	
;I2c.c: 200: SSPBUF=decimal_to_bcd(_mon);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l2331:	
;I2c.c: 207: SSPBUF=decimal_to_bcd(_yr);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l2333:	
;I2c.c: 214: SSPBUF=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(19)	;volatile
	line	215
;I2c.c: 215: while(SSPIF==0);
	goto	l669
...
;; Defined at:
;;		line 84 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _lcd_init *****************
;; Defined at:
;;		line 75 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 135 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
;;  value           1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
...
l2291:	
;I2c.c: 136: unsigned char msb,lsb,hex;
;I2c.c: 137: msb=value/10;
	movlw	low(0Ah)
	movwf	(?___awdiv)
	movlw	high(0Ah)
	movwf	((?___awdiv))+1
...
;; *************** function _lcd_data *****************
;; Defined at:
;;		line 50 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
...
l2265:	
;I2c.c: 51: unsigned char val1;
;I2c.c: 52: PORTD=data&0xf0;
...
;; Defined at:
;;		line 26 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
...
l2239:	
;I2c.c: 27: unsigned char temp;
;I2c.c: 28: PORTD=COM&0Xf0;
...
;; *************** function _delay *****************
;; Defined at:
;;		line 22 in file "C:\Users\TECH\Desktop\madhu pic folder\I2C\I2c\I2c.c"
;; Parameters:    Size  Location     Type
