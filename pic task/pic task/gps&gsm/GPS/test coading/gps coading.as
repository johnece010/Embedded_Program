...
z	equ	0
pclath	equ	10
# 2 "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
...
__pidataBANK0:
	file	"D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
	line	7
...
;; *************** function _main *****************
;; Defined at:
;;		line 174 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
...
l2255:	
;gps coading.c: 175: lcd_init();
	fcall	_lcd_init
	line	176
	
l2257:	
;gps coading.c: 176: gps_init();
	fcall	_gps_init
	line	177
	
l2259:	
;gps coading.c: 177: delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2263:	
;gps coading.c: 179: lcd_cmd(0x80);
	movlw	(080h)
	fcall	_lcd_cmd
	line	180
	
l2265:	
;gps coading.c: 180: lcd_cmd(0x01);
	movlw	(01h)
	fcall	_lcd_cmd
	line	181
	
l2267:	
;gps coading.c: 181: lcd_display("WELCOME");
...
l2275:	
;gps coading.c: 183: delay(50000);delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
;; *************** function _gps_send *****************
;; Defined at:
;;		line 115 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _lcd_init *****************
;; Defined at:
;;		line 81 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2191:	
;gps coading.c: 82: lcd_cmd(0x02);
	movlw	(02h)
	fcall	_lcd_cmd
	line	83
;gps coading.c: 83: lcd_cmd(0x2c);
	movlw	(02Ch)
	fcall	_lcd_cmd
	line	84
;gps coading.c: 84: lcd_cmd(0x06);
	movlw	(06h)
	fcall	_lcd_cmd
	line	85
;gps coading.c: 85: lcd_cmd(0x01);
	movlw	(01h)
	fcall	_lcd_cmd
	line	86
;gps coading.c: 86: lcd_cmd(0x0c);
	movlw	(0Ch)
	fcall	_lcd_cmd
	line	87
;gps coading.c: 87: lcd_cmd(0x80);
	movlw	(080h)
	fcall	_lcd_cmd
	line	88
...
;; Defined at:
;;		line 71 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _lcd_data *****************
;; Defined at:
;;		line 52 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _lcd_cmd *****************
;; Defined at:
;;		line 33 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _gps_init *****************
;; Defined at:
;;		line 17 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _delay *****************
;; Defined at:
;;		line 10 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _rcx *****************
;; Defined at:
;;		line 93 in file "D:\Madhu\madhu pic folder\gps&gsm\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
