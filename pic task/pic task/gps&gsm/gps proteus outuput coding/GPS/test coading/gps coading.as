...
z	equ	0
pclath	equ	10
# 2 "F:\kutty\GPS\test coading\gps coading.c"
...
__pidataBANK0:
	file	"F:\kutty\GPS\test coading\gps coading.c"
	line	8
...
??_gps_send:	; 0 bytes @ 0x6
	ds	1
;;Data sizes: Strings 12, constant 0, data 2, bss 57, persistent 0 stack 0
...
;; *************** function _main *****************
;; Defined at:
;;		line 174 in file "F:\kutty\GPS\test coading\gps coading.c"
...
l2271:	
;gps coading.c: 175: TRISB=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(134)^080h	;volatile
	line	176
;gps coading.c: 176: PORTB=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	178
;gps coading.c: 178: TRISD=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(136)^080h	;volatile
	line	179
;gps coading.c: 179: PORTD=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(8)	;volatile
	line	181
...
l2277:	
;gps coading.c: 184: lcd_init();
	fcall	_lcd_init
	line	185
	
l2279:	
;gps coading.c: 185: delay(500);
	movlw	low(01F4h)
	movwf	(?_delay)
	movlw	high(01F4h)
	movwf	((?_delay))+1
...
l2281:	
;gps coading.c: 187: gps_init();
	fcall	_gps_init
	line	188
	
l2283:	
;gps coading.c: 188: delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2287:	
;gps coading.c: 190: lcd_cmd(0x80);
	movlw	(080h)
	fcall	_lcd_cmd
	line	191
	
l2289:	
;gps coading.c: 191: lcd_cmd(0x01);
	movlw	(01h)
	fcall	_lcd_cmd
	line	192
	
l2291:	
;gps coading.c: 192: lcd_display("WELCOME");
	movlw	((STR_2-__stringbase))&0ffh
	fcall	_lcd_display
	line	193
	
l2293:	
;gps coading.c: 193: delay(50000);delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2299:	
;gps coading.c: 194: delay(50000);delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
;; *************** function _gps_send *****************
;; Defined at:
;;		line 116 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _lcd_init *****************
;; Defined at:
;;		line 82 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; Defined at:
;;		line 72 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _lcd_data *****************
;; Defined at:
;;		line 53 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _lcd_cmd *****************
;; Defined at:
;;		line 34 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _gps_init *****************
;; Defined at:
;;		line 18 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _delay *****************
;; Defined at:
;;		line 11 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _rcx *****************
;; Defined at:
;;		line 94 in file "F:\kutty\GPS\test coading\gps coading.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
