...
;; *************** function _main *****************
;; Defined at:
;;		line 181 in file "C:\Users\TECH\Desktop\madhu pic folder\gps&gsm\Eneregy meter using GSM\interrupt test.c"
...
l2464:	
;interrupt test.c: 182: ADCON1=0X80;
	movlw	(080h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(159)^080h	;volatile
	line	183
;interrupt test.c: 183: ADCON0=0X40;
	movlw	(040h)
...
l2466:	
;interrupt test.c: 185: TRISD=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l2468:	
;interrupt test.c: 186: PORTD=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(8)	;volatile
	line	188
;interrupt test.c: 188: TRISA=0x01;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l2470:	
;interrupt test.c: 189: PORTA=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(5)	;volatile
	line	191
...
l2472:	
;interrupt test.c: 191: TRISC=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l2474:	
;interrupt test.c: 192: PORTC=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(7)	;volatile
	line	194
...
l2476:	
;interrupt test.c: 194: TRISB=0X03;
	movlw	(03h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(134)^080h	;volatile
	line	195
;interrupt test.c: 195: PORTB=0X00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	197
...
l2478:	
;interrupt test.c: 197: lcd_init();
	fcall	_lcd_init
	line	198
	
l2480:	
;interrupt test.c: 198: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2482:	
;interrupt test.c: 200: TXSTA=0x24;
	movlw	(024h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l2484:	
;interrupt test.c: 201: RCSTA=0x90;
	movlw	(090h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(24)	;volatile
...
l2488:	
;interrupt test.c: 204: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2490:	
;interrupt test.c: 205: PEIE=1;
	bsf	(94/8),(94)&7
	line	206
	
l2492:	
;interrupt test.c: 206: GIE=1;
	bsf	(95/8),(95)&7
	line	208
	
l2494:	
;interrupt test.c: 208: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2496:	
;interrupt test.c: 209: lcd_cmd(0x80);
	movlw	(080h)
	fcall	_lcd_cmd
	line	211
	
l2498:	
;interrupt test.c: 211: lcd_display("WELCOME");
	movlw	((STR_3-__stringbase))&0ffh
	fcall	_lcd_display
	line	212
	
l2500:	
;interrupt test.c: 212: delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2504:	
;interrupt test.c: 213: lcd_cmd(0x01);
	movlw	(01h)
	fcall	_lcd_cmd
	line	214
;interrupt test.c: 214: while(1)
	
l641:	
	line	216
	
l2506:	
;interrupt test.c: 215: {
;interrupt test.c: 216: CHS2=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(253/8),(253)&7
	line	217
...
l2508:	
;interrupt test.c: 217: CHS1=0;
	bcf	(252/8),(252)&7
	line	218
	
l2510:	
;interrupt test.c: 218: CHS0=0;
	bcf	(251/8),(251)&7
	line	219
	
l2512:	
;interrupt test.c: 219: ADON=1;
	bsf	(248/8),(248)&7
	line	220
	
l2514:	
;interrupt test.c: 220: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2516:	
;interrupt test.c: 221: ADCON0=(ADCON0|0X04);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(31),w	;volatile
	iorlw	04h
...
l2518:	
;interrupt test.c: 222: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2520:	
;interrupt test.c: 223: temmp=ADRESH<<8;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(30),w	;volatile
	movwf	(??_main+0)+0
...
l2522:	
;interrupt test.c: 224: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2524:	
;interrupt test.c: 225: temmp=temmp+ADRESL;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l2528:	
;interrupt test.c: 227: PORTD=temmp;
	movf	(_temmp),w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l2532:	
;interrupt test.c: 229: a=temmp/1000;
	movlw	low(03E8h)
	movwf	(?___awdiv)
	movlw	high(03E8h)
	movwf	((?___awdiv))+1
...
l2534:	
;interrupt test.c: 230: b=temmp%1000;
	movlw	low(03E8h)
	movwf	(?___awmod)
	movlw	high(03E8h)
	movwf	((?___awmod))+1
...
l2544:	
;interrupt test.c: 236: lcd_cmd(0xC0);
	movlw	(0C0h)
	fcall	_lcd_cmd
	line	237
	
l2546:	
;interrupt test.c: 237: lcd_data(a+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
...
l2548:	
;interrupt test.c: 238: delay(5000);
	movlw	low(01388h)
	movwf	(?_delay)
	movlw	high(01388h)
	movwf	((?_delay))+1
...
l2550:	
;interrupt test.c: 239: lcd_data(z+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_z),w
	addlw	030h
...
l2552:	
;interrupt test.c: 240: delay(5000);
	movlw	low(01388h)
	movwf	(?_delay)
	movlw	high(01388h)
	movwf	((?_delay))+1
...
l2554:	
;interrupt test.c: 241: lcd_data(e+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_e),w
	addlw	030h
...
l2556:	
;interrupt test.c: 242: delay(5000);
	movlw	low(01388h)
	movwf	(?_delay)
	movlw	high(01388h)
	movwf	((?_delay))+1
...
l2558:	
;interrupt test.c: 243: lcd_data(f+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_f),w
	addlw	030h
...
l2560:	
;interrupt test.c: 244: delay(5000);
	movlw	low(01388h)
	movwf	(?_delay)
	movlw	high(01388h)
	movwf	((?_delay))+1
...
l2562:	
;interrupt test.c: 246: if(temmp>=500)
	movf	(_temmp+1),w
	xorlw	80h
	movwf	btemp+0
...
l2564:	
;interrupt test.c: 247: {
;interrupt test.c: 248: lcd_cmd(0x01);
	movlw	(01h)
	fcall	_lcd_cmd
	line	249
;interrupt test.c: 249: lcd_cmd(0x80);
	movlw	(080h)
	fcall	_lcd_cmd
	line	250
	
l2566:	
;interrupt test.c: 250: lcd_display("sensor abnormal");
	movlw	((STR_4-__stringbase))&0ffh
	fcall	_lcd_display
	line	251
	
l2568:	
;interrupt test.c: 251: delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
	fcall	_delay
	line	252
;interrupt test.c: 252: serial("AT");
	movlw	((STR_5-__stringbase))&0ffh
	fcall	_serial
	line	253
	
l2570:	
;interrupt test.c: 253: txs(13);delay(60000);delay(60000);
	movlw	(0Dh)
	fcall	_txs
...
l2576:	
;interrupt test.c: 254: txs(10);
	movlw	(0Ah)
	fcall	_txs
	line	255
	
l2578:	
;interrupt test.c: 255: delay(10000);
	movlw	low(02710h)
	movwf	(?_delay)
	movlw	high(02710h)
	movwf	((?_delay))+1
...
l2580:	
;interrupt test.c: 256: delay(10000);
	movlw	low(02710h)
	movwf	(?_delay)
	movlw	high(02710h)
	movwf	((?_delay))+1
	fcall	_delay
	line	257
;interrupt test.c: 257: serial("AT+CMGF=1");
	movlw	((STR_6-__stringbase))&0ffh
	fcall	_serial
	line	258
	
l2582:	
;interrupt test.c: 258: txs(13);delay(60000);delay(60000);
	movlw	(0Dh)
	fcall	_txs
...
l2588:	
;interrupt test.c: 259: txs(10);
	movlw	(0Ah)
	fcall	_txs
	line	260
	
l2590:	
;interrupt test.c: 260: delay(10000);
	movlw	low(02710h)
	movwf	(?_delay)
	movlw	high(02710h)
	movwf	((?_delay))+1
...
;interrupt test.c: 261: delay(10000);
	...
	fcall	_delay
	line	263
;interrupt test.c: 263: sms1();
	fcall	_sms1
	line	264
;interrupt test.c: 264: sms2();
	fcall	_sms2
	line	265
...
;; *************** function _serial *****************
;; Defined at:
;;		line 170 in file "C:\Users\TECH\Desktop\madhu pic folder\gps&gsm\Eneregy meter using GSM\interrupt test.c"
;; Parameters:    Size  Location     Type
...
l2444:	
;interrupt test.c: 171: unsigned char i;
;interrupt test.c: 172: for(i=0;a[i]!=0;i++)
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l2446:	
;interrupt test.c: 173: {
;interrupt test.c: 174: TXREG=a[i];
	movf	(serial@i),w
	addwf	(serial@a),w
	movwf	fsr0
	fcall	stringdir
...
l2448:	
;interrupt test.c: 175: delay(20000);
	movlw	low(04E20h)
	movwf	(?_delay)
	movlw	high(04E20h)
	movwf	((?_delay))+1
...
;; *************** function _sms2 *****************
;; Defined at:
;;		line 129 in file "C:\Users\TECH\Desktop\madhu pic folder\gps&gsm\Eneregy meter using GSM\interrupt test.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2400:	
;interrupt test.c: 130: txs('A');txs('T');txs('+');txs('C');txs('M');txs('G');
	movlw	(041h)
	fcall	_txs
	movlw	(054h)
	fcall	_txs
	...
	fcall	_txs
	line	131
;interrupt test.c: 131: txs('S');txs('=');
	movlw	(053h)
	fcall	_txs
	movlw	(03Dh)
	fcall	_txs
	line	132
;interrupt test.c: 132: txs('"');
	movlw	(022h)
	fcall	_txs
	line	133
;interrupt test.c: 133: txs('8');txs('0');txs('9');txs('8');txs('1');
	movlw	(038h)
	fcall	_txs
	movlw	(030h)
	fcall	_txs
	...
	fcall	_txs
	line	134
;interrupt test.c: 134: txs('4');txs('2');txs('0');txs('6');txs('4');
	movlw	(034h)
	fcall	_txs
	movlw	(032h)
	fcall	_txs
	...
	fcall	_txs
	line	135
;interrupt test.c: 135: txs('"');
	movlw	(022h)
	fcall	_txs
	line	136
;interrupt test.c: 136: txs(13); delay(10000);txs(10);
	movlw	(0Dh)
	fcall	_txs
	movlw	low(02710h)
	movwf	(?_delay)
	...
	fcall	_txs
	line	138
;interrupt test.c: 138: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
	fcall	_delay
	line	139
;interrupt test.c: 139: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2402:	
;interrupt test.c: 142: gsm_command("sensor abnormal");
	movlw	((STR_2-__stringbase))&0ffh
	fcall	_gsm_command
	line	143
	
l2404:	
;interrupt test.c: 143: delay(10000);
	movlw	low(02710h)
	movwf	(?_delay)
	movlw	high(02710h)
	movwf	((?_delay))+1
...
l2406:	
;interrupt test.c: 144: TXREG=0x0D;
	movlw	(0Dh)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(25)	;volatile
...
l2408:	
;interrupt test.c: 147: TXREG=(a+0x30);
	movf	(_a),w
	addlw	030h
	movwf	(25)	;volatile
	line	148
...
l2410:	
;interrupt test.c: 148: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2412:	
;interrupt test.c: 149: TXREG=(z+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_z),w
	addlw	030h
...
l2414:	
;interrupt test.c: 150: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2416:	
;interrupt test.c: 151: TXREG=(e+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_e),w
	addlw	030h
...
l2418:	
;interrupt test.c: 152: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2420:	
;interrupt test.c: 153: TXREG=(f+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_f),w
	addlw	030h
...
l2422:	
;interrupt test.c: 154: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2424:	
;interrupt test.c: 158: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2426:	
;interrupt test.c: 159: txs(13);delay(60000);
	movlw	(0Dh)
	fcall	_txs
...
l2430:	
;interrupt test.c: 160: txs(10);
	movlw	(0Ah)
	fcall	_txs
	line	161
	
l2432:	
;interrupt test.c: 161: delay(10000);
	movlw	low(02710h)
	movwf	(?_delay)
	movlw	high(02710h)
	movwf	((?_delay))+1
...
l2434:	
;interrupt test.c: 163: txs(26);
	movlw	(01Ah)
	fcall	_txs
	line	164
	
l2436:	
;interrupt test.c: 164: delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2440:	
;interrupt test.c: 165: delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2360:	
;interrupt test.c: 104: TXREG=0x0D;
	movlw	(0Dh)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(25)	;volatile
...
l2362:	
;interrupt test.c: 106: delay(5000);
	movlw	low(01388h)
	movwf	(?_delay)
	movlw	high(01388h)
	movwf	((?_delay))+1
...
l2364:	
;interrupt test.c: 107: TXREG=(a+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
...
l2366:	
;interrupt test.c: 108: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2368:	
;interrupt test.c: 109: TXREG=(z+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_z),w
	addlw	030h
...
l2370:	
;interrupt test.c: 110: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2372:	
;interrupt test.c: 111: TXREG=(e+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_e),w
	addlw	030h
...
l2374:	
;interrupt test.c: 112: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2376:	
;interrupt test.c: 113: TXREG=(f+0x30);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_f),w
	addlw	030h
...
l2378:	
;interrupt test.c: 114: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l2380:	
;interrupt test.c: 118: delay(600);
	movlw	low(0258h)
	movwf	(?_delay)
	movlw	high(0258h)
	movwf	((?_delay))+1
...
l2382:	
;interrupt test.c: 119: txs(13);delay(60000);
	movlw	(0Dh)
	fcall	_txs
...
l2386:	
;interrupt test.c: 120: txs(10);
	movlw	(0Ah)
	fcall	_txs
	line	121
	
l2388:	
;interrupt test.c: 121: delay(10000);
	movlw	low(02710h)
	movwf	(?_delay)
	movlw	high(02710h)
	movwf	((?_delay))+1
...
l2390:	
;interrupt test.c: 123: txs(26);
	movlw	(01Ah)
	fcall	_txs
	line	124
	
l2392:	
;interrupt test.c: 124: delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
l2396:	
;interrupt test.c: 125: delay(50000);delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
