	...
	; Compiler options:
	;
	; -owomen safety concept sensor abnormal gps on gsm.cof \
	; -mwomen safety concept sensor abnormal gps on gsm.map \
	; --summary=default --output=default \
	; women safety concept sensor abnormal gps on gsm.p1 --chip=16F877A -P \
