...
z	equ	0
pclath	equ	10
# 2 "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
...
;; *************** function _main *****************
;; Defined at:
;;		line 43 in file "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
...
;;
psect	maintext
	file	"E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
	line	43
...
l1780:	
;lcd test.c: 44: TRISD=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(136)^080h	;volatile
	line	45
;lcd test.c: 45: PORTD=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(8)	;volatile
	line	47
;lcd test.c: 47: TRISC=0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(135)^080h	;volatile
	line	48
;lcd test.c: 48: PORTC=0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(7)	;volatile
	line	50
...
l1782:	
;lcd test.c: 50: lcd_init();
	fcall	_lcd_init
	line	51
	
l1784:	
;lcd test.c: 51: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
l1786:	
;lcd test.c: 53: {
;lcd test.c: 54: lcd_command(0X80);
	movlw	(080h)
	fcall	_lcd_command
	line	55
	
l1788:	
;lcd test.c: 55: lcd_display("WELCOME");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_lcd_display
	line	56
	
l1790:	
;lcd test.c: 56: delay(50000);
	movlw	low(0C350h)
	movwf	(?_delay)
	movlw	high(0C350h)
	movwf	((?_delay))+1
...
;; Defined at:
;;		line 36 in file "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
;; Parameters:    Size  Location     Type
...
l1772:	
;lcd test.c: 37: for(int i=0;m[i]!=0;i++)
	movlw	low(0)
	movwf	(lcd_display@i)
	movlw	high(0)
...
;; *************** function _lcd_init *****************
;; Defined at:
;;		line 20 in file "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l1770:	
;lcd test.c: 21: lcd_command(0x38);
	movlw	(038h)
	fcall	_lcd_command
	line	22
;lcd test.c: 22: lcd_command(0x06);
	movlw	(06h)
	fcall	_lcd_command
	line	23
;lcd test.c: 23: lcd_command(0x0c);
	movlw	(0Ch)
	fcall	_lcd_command
	line	24
;lcd test.c: 24: lcd_command(0x01);
	movlw	(01h)
	fcall	_lcd_command
	line	25
...
;; *************** function _lcd_data *****************
;; Defined at:
;;		line 27 in file "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
;; Parameters:    Size  Location     Type
...
;; Defined at:
;;		line 11 in file "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _delay *****************
;; Defined at:
;;		line 7 in file "E:\Embedded_Program\pic task\pic task\lcd dispaly\lcd test\lcd test.c"
;; Parameters:    Size  Location     Type
