	...
	; Compiler options:
	;
	; -oone by one decending led blinking.cof \
	; -mone by one decending led blinking.map --summary=default \
	; --output=default one by one decending led blinking.p1 --chip=16F877A \
