	...
	; Compiler options:
	;
	; -oadc value display on lcd and virtual terminal.cof \
	; -madc value display on lcd and virtual terminal.map --summary=default \
	; --output=default adc value display on lcd and virtual terminal.p1 \
